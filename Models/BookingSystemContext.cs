...
public partial class BookingSystemContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<BookingStatus>(entity =>
        {
            ...
            entity.Property(e => e.StatusName).HasMaxLength(50).HasColumnName("status_name");
        });
        ...
        modelBuilder.Entity<Workspace>(entity =>
        {
            ...
            entity.Property(e => e.Number).HasMaxLength(20).HasColumnName("number");
            entity.Property(e => e.PricePerHour).HasPrecision(10, 2).HasColumnName("price_per_hour");
